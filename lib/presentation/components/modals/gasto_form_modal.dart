    ...
    return Padding(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        AnimatedBuilder(
          ...
          builder: (_, __) {
            final tipo = _tabCtrl.index == 0 ? 'gasto' : 'ingreso';
            final catsfiltradas = cats
                .where((c) => c.tipo == tipo || c.tipo == 'ahorro')
                .toList();
            ...
            return Column(
              ...
              children: [
                ...
                catsfiltradas.isEmpty
                    ? const Text('Sin categorías para este tipo',
                        style:
                            TextStyle(color: AppTheme.textGrey, fontSize: 13))
                    : Wrap(
                        spacing: 8,
                        runSpacing: 8,
                        children: catsfiltradas.map((cat) {
